...
void DetectorConstruction::DefineMaterials()
{
  ...
  epoxy->AddElement(H,0.1318);
  epoxy->AddElement(O,0.3328);
  ...
  G4Material* Cu_Water = new G4Material("Cu_Water",5.69*g/cm3,2);
  Cu_Water->AddMaterial(H2O,0.072);
  Cu_Water->AddMaterial(Cu,0.928);
